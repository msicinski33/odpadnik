...
CREATE TABLE "new_DailyAssignment" (
    ...
    CONSTRAINT "DailyAssignment_municipalityId_fkey" FOREIGN KEY ("municipalityId") REFERENCES "Municipality" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_DailyAssignment" ("date", "driverId", "id", "regionId", "shift", "type", "vehicleId") SELECT "date", "driverId", "id", "regionId", "shift", "type", "vehicleId" FROM "DailyAssignment";
